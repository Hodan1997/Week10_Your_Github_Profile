...
function App() {
  ...
  // Halkaan isticmaal axios adigoo kasoo jiidanaayo waxaa u baahantahay API, useEffect hook-na isticmaal
    useEffect(() => {
      axios.get('https://api.github.com/users/<your-github-username')
      .then((res) => {
    ...
    useEffect(() => {
      axios.get('https://api.github.com/users/<your-github-username>/followers')
      .then((res) => {
        console.log("res", res.data)
    ...
    useEffect(() => {
      axios.get('https://api.github.com/users/<your-github-username>/following')
      .then((res) => {
        console.log("res", res.data)
